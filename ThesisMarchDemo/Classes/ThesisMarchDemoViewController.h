...
@interface ThesisMarchDemoViewController : UIViewController <MKMapViewDelegate, UIAlertViewDelegate, CLLocationManagerDelegate>
...
{	
	...
	MKMapView *map;	 
	IBOutlet UIButton *loadingSounds;
