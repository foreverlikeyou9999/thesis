...
@implementation ThesisMarchDemoViewController


@synthesize map, whereabouts;
@synthesize loadingSounds; 
...

{
	...
	if (self.locationManager.locationServicesEnabled)
	{
		...
		whereabouts.text=@"This application cannot function without Location Services. Please relaunch and enable.";
...
- (void) locationManager:(CLLocationManager *)locationManager didUpdateToLocation:(CLLocation *)newLocation fromLocation:(CLLocation *)location {
	...
	// NSLog (@"coordintates are %f", testAnnotation.coordinate); 
	 ...
	 //[map addAnnotation:testAnnotation];
...

{
	...
	/* Removed because Location Manager is in App Delegate at this point
...
/* Removed, again; Location Manager is in App Delegate. This is just to test the map with said code inserted.
...
/* Commented Out. Currently locationManager in App Delegate
...
/* Commented out; Location Manager in App Delegate
